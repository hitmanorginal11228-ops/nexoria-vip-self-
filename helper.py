...
# مقادیر از متغیرهای محیطی (Environment Variables) خونده میشن - توی پنل Render ست کنید
TOKEN = os.environ.get("HELPER_BOT_TOKEN")  # توکن ربات هلپر (از BotFather)
COMMAND_FILE = "selfbot_commands.json"
SETTINGS_FILE = "settings.json"
REACTION_RESULT_FILE = "reaction_result.json"
PANEL_IMAGE = os.environ.get("PANEL_IMAGE", "link")  # لینک عکس هلپر، اگر نداری از تنظیمات ربات ست کن
PHOTO_FILE = "panel_photo.json"
ADMIN_ID = int(os.environ.get("ADMIN_ID", "0"))  # ایدی عددی ادمین
MANAGER_BOT_LINK = os.environ.get("MANAGER_BOT_LINK", "https://t.me/0000")  # لینک ربات سلف‌ساز (bot.py)

if not TOKEN or not ADMIN_ID:
    print("⚠️ متغیرهای محیطی HELPER_BOT_TOKEN / ADMIN_ID ست نشدن!")
